    ...
    <div class="container table-wrapper">
        ...
        <table class="table table-striped table-hover table-bordered">
            <thead>
                <tr>
                    <th scope="col">Sno</th>
                    <th scope="col" onclick="sortByColumn('courseName')">CourseName</th>
                    <th scope="col" onclick="sortByColumn('createdAt')">CreatedAt</th>
                    <th scope="col" onclick="sortByColumn('created')">CreatedBy</th>
                    <th scope="col" onclick="sortByColumn('UpdatedAt')">UpdatedAt</th>
                    <th scope="col" onclick="sortByColumn('updated')">UpdatedBy</th>
                    <th scope="col">Action</th>
                </tr>
            </thead>
            <tbody id="courseData">
...
<script>
    ...
    var paginationDom = document.getElementById("pagination");
    // var sortOrder = 'ASC';
    // var url = `&orderby=c.createdAt&sort=DESC`;
    ...
    function sortByColumn(column) {
        ...
        // if (currentColumn === 'createdFirstName' || 'updatedFirstName') {
        //     url = `&orderby=w.${currentColumn}&sort=${sortOrder}`
        //     console.log(url)
        // }

        
        if (currentColumn === 'created' || 'updated') {
            url = `&orderby=w.${currentColumn}&sort=${sortOrder}`
            console.log(url)
        }
            ...
            .then(responseData => {
                ...
                for (let i = 0; i < courses.length; i++) {
                    ...
                    trHtml += `<tr>
                            ...
                            <td>${course.updatedAt}</td>
                            <td>${course.updatedFirstName} ${course.updatedLastName}</td>
                            <td>
                                <a class="btn btn-secondary" href="/course/${course.courseId}">Edit</a>
                                <a class="btn btn-secondary" onClick="deleteCourse(${course.courseId})">Delete</a>
                            </td>
